...
class SettingServer {
    ...
    public:
        SettingServer(EEPROM_Settings& settings) : 
    ...
    private:
        ...
        String page = "<!DOCTYPE html>"
            ...
            "</head>"
            "<body>"
                + String(settings.getSSID().c_str()) + "/" + String(settings.getPassword().c_str()) + "<br/>" +
                "<div id=\"content\">"
                "<h2>D&D Alerter - Setup</h2>"
                    + generateMessage() +
                    "<p>Connect the D&D Alerter to your WiFi</p>"
